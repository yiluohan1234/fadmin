...
@section('header')
    <section class="content-header">
      ...
      <li class="active">{{ trans('logmanager.preview') }}</li>
      </ol>
    </section>
@endsection
...
@section('content')
  ...
  <a href="{{ url(config('fadmin.base.route_prefix', 'admin').'/log') }}"><i class="fa fa-angle-double-left"></i> {{ trans('logmanager.back_to_all_logs') }}</a><br><br>
<!-- Default box -->
  <div class="box">
    <div class="box-body">
      <h3>{{ $file_name }}:</h3>

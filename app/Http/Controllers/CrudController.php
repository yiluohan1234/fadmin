...
use App\Http\Controllers\CrudFeatures\Reorder;
use App\Http\Controllers\CrudFeatures\AjaxTable;
use App\Http\Controllers\CrudFeatures\Revisions;
use App\Http\Controllers\CrudFeatures\SaveActions;
use App\Http\Controllers\CrudFeatures\ShowDetailsRow;
...
class CrudController extends BaseController
{
    ...
    public function show($id)
    {
        ...
        $this->data['entry'] = $this->crud->getEntry($id);
        $this->data['crud'] = $this->crud;
        $this->data['title'] = trans('crud.preview').' '.$this->crud->entity_name;

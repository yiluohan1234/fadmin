...
trait Read
{
    ...
    */
    ...
    public function getDefaultPageLength()
    {
        ...
        if (config('fadmin.crud.default_page_length')) {
            return config('fadmin.crud.default_page_length');
        }
    ...
    public function getPageLengthMenu()
    {
        ...
        if (! $this->page_length_menu) {
            ...
            if (! $this->page_length_menu = config('fadmin.crud.page_length_menu')) {
                // otherwise set a sensible default
                $this->page_length_menu = [[10, 25, 50, 100, -1], [10, 25, 50, 100, 'crud.all']];
            }
